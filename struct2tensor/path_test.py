...
class PathTest(parameterized.TestCase):
    ...
    def test_valid_map_indexing_step(self):
        ...
        self.assertSequenceEqual(
            ["my_map[]", "some_value"], create_path("my_map[].some_value").field_list
        )
        self.assertSequenceEqual(
    ...
    def test_expand_paths_ending_in_wildcard(self, descriptor, input_paths, expected):
        self.assertCountEqual(
