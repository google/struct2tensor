...
class Path:
    ...
    def __cmp__(
        self, other: "Path"
    ) -> int:  # pytype: disable=signature-mismatch  # overriding-return-type-checks
    ...
    def get_parent(self) -> "Path":
        ...
        return Path(
            self.field_list[:-1], validate_step_format=self._validate_step_format
        )
