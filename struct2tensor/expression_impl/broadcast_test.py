...
class BroadcastTest(tf.test.TestCase):
    def test_broadcast_anonymous(self):
        ...
        new_root, p = broadcast.broadcast_anonymous(expr, path.Path(["foo"]), "user")
    ...
    def test_broadcast(self):
        ...
        new_root = broadcast.broadcast(expr, path.Path(["foo"]), "user", "new_field")
    ...
    def test_broadcast_substructure(self):
        ...
        self.assertAllEqual(
            new_friends_node.values, ["a", "b", "c", "d", "b", "c", "d"]
        )
    ...
    def test_broadcast_substructure_deep(self):
        ...
        new_root = broadcast.broadcast(expr, path.Path(["event"]), "user", "new_event")
        ...
        self.assertAllEqual(new_bar_node.values, ["a", "b", "c", "d", "b", "c", "d"])
        ...
        self.assertAllEqual(new_keep_me_node.values, [False, True, True])
