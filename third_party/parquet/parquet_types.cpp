...
int _kConvertedTypeValues[] = {ConvertedType::UTF8,
                               ConvertedType::MAP,
...
const char* _kConvertedTypeNames[] = {"UTF8",
                                      "MAP",
                                      "MAP_KEY_VALUE",
                                      "LIST",
                                      "ENUM",
...
const std::map<int, const char*> _ConvertedType_VALUES_TO_NAMES(
    ::apache::thrift::TEnumIterator(22, _kConvertedTypeValues,
...
int _kFieldRepetitionTypeValues[] = {FieldRepetitionType::REQUIRED,
                                     FieldRepetitionType::OPTIONAL,
                                     FieldRepetitionType::REPEATED};
const char* _kFieldRepetitionTypeNames[] = {"REQUIRED", "OPTIONAL", "REPEATED"};
...
int _kEncodingValues[] = {Encoding::PLAIN,
...
const char* _kEncodingNames[] = {"PLAIN",
                                 "PLAIN_DICTIONARY",
                                 "RLE",
                                 "BIT_PACKED",
                                 "DELTA_BINARY_PACKED",
...
int _kCompressionCodecValues[] = {
    ...
    CompressionCodec::GZIP,         CompressionCodec::LZO,
    CompressionCodec::BROTLI,       CompressionCodec::LZ4,
    CompressionCodec::ZSTD};
const char* _kCompressionCodecNames[] = {
    "UNCOMPRESSED", "SNAPPY", "GZIP", "LZO", "BROTLI", "LZ4", "ZSTD"};
const std::map<int, const char*> _CompressionCodec_VALUES_TO_NAMES(
    ::apache::thrift::TEnumIterator(7, _kCompressionCodecValues,
...
int _kPageTypeValues[] = {PageType::DATA_PAGE, PageType::INDEX_PAGE,
...
int _kBoundaryOrderValues[] = {BoundaryOrder::UNORDERED,
...
const std::map<int, const char*> _BoundaryOrder_VALUES_TO_NAMES(
    ::apache::thrift::TEnumIterator(3, _kBoundaryOrderValues,
...
StringType::StringType(const StringType& other2) { (void)other2; }
...
UUIDType::UUIDType(const UUIDType& other4) { (void)other4; }
...
MapType::MapType(const MapType& other6) { (void)other6; }
...
ListType::ListType(const ListType& other8) { (void)other8; }
...
EnumType::EnumType(const EnumType& other10) { (void)other10; }
...
DateType::DateType(const DateType& other12) { (void)other12; }
...
NullType::NullType(const NullType& other14) { (void)other14; }
...
MilliSeconds::MilliSeconds(const MilliSeconds& other18) { (void)other18; }
...
MicroSeconds::MicroSeconds(const MicroSeconds& other20) { (void)other20; }
...
NanoSeconds::NanoSeconds(const NanoSeconds& other22) { (void)other22; }
...
uint32_t TimestampType::write(
  ...
  xfer += oprot->writeFieldBegin("isAdjustedToUTC",
...
JsonType::JsonType(const JsonType& other32) { (void)other32; }
...
BsonType::BsonType(const BsonType& other34) { (void)other34; }
...
uint32_t LogicalType::write(
  ...
  if (this->__isset.DECIMAL) {
    xfer += oprot->writeFieldBegin("DECIMAL",
...
uint32_t SchemaElement::write(
  ...
  if (this->__isset.logicalType) {
    xfer += oprot->writeFieldBegin("logicalType",
                                   ::apache::thrift::protocol::T_STRUCT, 10);
...
uint32_t BloomFilterAlgorithm::write(
  ...
  if (this->__isset.BLOCK) {
    xfer += oprot->writeFieldBegin("BLOCK",
                                   ::apache::thrift::protocol::T_STRUCT, 1);
...
XxHash::XxHash(const XxHash& other60) { (void)other60; }
...
uint32_t BloomFilterHash::write(
  ...
  if (this->__isset.XXHASH) {
    xfer += oprot->writeFieldBegin("XXHASH",
                                   ::apache::thrift::protocol::T_STRUCT, 1);
...
Uncompressed::Uncompressed(const Uncompressed& other64) { (void)other64; }
...
uint32_t BloomFilterCompression::write(
  ...
  if (this->__isset.UNCOMPRESSED) {
    xfer += oprot->writeFieldBegin("UNCOMPRESSED",
                                   ::apache::thrift::protocol::T_STRUCT, 1);
...
uint32_t BloomFilterHeader::write(
  ...
  xfer += oprot->writeFieldBegin("algorithm",
                                 ::apache::thrift::protocol::T_STRUCT, 2);
  ...
  xfer += oprot->writeFieldBegin("compression",
...
uint32_t ColumnMetaData::write(
                                 ...
                                 ::apache::thrift::protocol::T_LIST, 3);
  {
    ...
    for (_iter105 = this->path_in_schema.begin();
         _iter105 != this->path_in_schema.end(); ++_iter105) {
  ...
  if (this->__isset.key_value_metadata) {
                                   ...
                                   ::apache::thrift::protocol::T_LIST, 8);
    {
      ...
      for (_iter106 = this->key_value_metadata.begin();
           _iter106 != this->key_value_metadata.end(); ++_iter106) {
  ...
  if (this->__isset.encoding_stats) {
                                   ...
                                   ::apache::thrift::protocol::T_LIST, 13);
    {
      ...
      for (_iter107 = this->encoding_stats.begin();
           _iter107 != this->encoding_stats.end(); ++_iter107) {
...
uint32_t EncryptionWithColumnKey::write(
                                 ...
                                 ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    for (_iter117 = this->path_in_schema.begin();
         _iter117 != this->path_in_schema.end(); ++_iter117) {
  ...
  if (this->__isset.key_metadata) {
    xfer += oprot->writeFieldBegin("key_metadata",
                                   ::apache::thrift::protocol::T_STRING, 2);
  ...
  if (this->__isset.sorting_columns) {
                                   ...
                                   ::apache::thrift::protocol::T_LIST, 4);
    {
      ...
      for (_iter135 = this->sorting_columns.begin();
           _iter135 != this->sorting_columns.end(); ++_iter135) {
...
uint32_t ColumnOrder::write(
  ...
  if (this->__isset.TYPE_ORDER) {
    xfer += oprot->writeFieldBegin("TYPE_ORDER",
                                   ::apache::thrift::protocol::T_STRUCT, 1);
...
uint32_t PageLocation::write(
  ...
  xfer += oprot->writeFieldBegin("first_row_index",
                                 ::apache::thrift::protocol::T_I64, 3);
...
uint32_t OffsetIndex::write(
  ...
  xfer += oprot->writeFieldBegin("page_locations",
                                 ::apache::thrift::protocol::T_LIST, 1);
  {
    xfer += oprot->writeListBegin(
        ::apache::thrift::protocol::T_STRUCT,
    ...
    for (_iter149 = this->page_locations.begin();
         _iter149 != this->page_locations.end(); ++_iter149) {
...
uint32_t ColumnIndex::write(
  ...
  xfer += oprot->writeFieldBegin("null_pages",
                                 ::apache::thrift::protocol::T_LIST, 1);
  {
    xfer +=
        oprot->writeListBegin(::apache::thrift::protocol::T_BOOL,
                              static_cast<uint32_t>(this->null_pages.size()));
    std::vector<bool>::const_iterator _iter173;
    for (_iter173 = this->null_pages.begin();
         _iter173 != this->null_pages.end(); ++_iter173) {
  ...
  xfer += oprot->writeFieldBegin("min_values",
                                 ::apache::thrift::protocol::T_LIST, 2);
  {
    xfer +=
    ...
    for (_iter174 = this->min_values.begin();
         _iter174 != this->min_values.end(); ++_iter174) {
  ...
  xfer += oprot->writeFieldBegin("max_values",
                                 ::apache::thrift::protocol::T_LIST, 3);
  {
    xfer +=
        oprot->writeListBegin(::apache::thrift::protocol::T_STRING,
    ...
    for (_iter175 = this->max_values.begin();
         _iter175 != this->max_values.end(); ++_iter175) {
  ...
  if (this->__isset.null_counts) {
    xfer += oprot->writeFieldBegin("null_counts",
                                   ::apache::thrift::protocol::T_LIST, 5);
    {
      ...
      for (_iter176 = this->null_counts.begin();
           _iter176 != this->null_counts.end(); ++_iter176) {
...
uint32_t AesGcmV1::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.aad_prefix) {
    xfer += oprot->writeFieldBegin("aad_prefix",
                                   ::apache::thrift::protocol::T_STRING, 1);
...
uint32_t EncryptionAlgorithm::write(
  ...
  if (this->__isset.AES_GCM_V1) {
    xfer += oprot->writeFieldBegin("AES_GCM_V1",
                                   ::apache::thrift::protocol::T_STRUCT, 1);
    xfer += this->AES_GCM_V1.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.AES_GCM_CTR_V1) {
    xfer += oprot->writeFieldBegin("AES_GCM_CTR_V1",
                                   ::apache::thrift::protocol::T_STRUCT, 2);
...
uint32_t FileMetaData::write(
                                 ...
                                 ::apache::thrift::protocol::T_LIST, 4);
  {
    ...
    for (_iter206 = this->row_groups.begin();
         _iter206 != this->row_groups.end(); ++_iter206) {
  ...
  if (this->__isset.key_value_metadata) {
                                   ...
                                   ::apache::thrift::protocol::T_LIST, 5);
    {
      ...
      for (_iter207 = this->key_value_metadata.begin();
           _iter207 != this->key_value_metadata.end(); ++_iter207) {
  ...
  if (this->__isset.column_orders) {
    xfer += oprot->writeFieldBegin("column_orders",
                                   ::apache::thrift::protocol::T_LIST, 7);
    {
      ...
      for (_iter208 = this->column_orders.begin();
           _iter208 != this->column_orders.end(); ++_iter208) {
