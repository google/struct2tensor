description: A dataset which reads columns from a parquet file and returns a prensor.

<div itemscope itemtype="http://developers.google.com/ReferenceObject">
<meta itemprop="name" content="expression_impl.parquet.ParquetDataset" />
...
# expression_impl.parquet.ParquetDataset
...
<code>expression_impl.parquet.ParquetDataset(
    filenames: List[str],
...
<td>
A list of strings of the dotstring path(s) of each leaf
path(s).
</td>
</tr><tr>
<td>
...
<td>
An int that determines how many messages are parsed into one
